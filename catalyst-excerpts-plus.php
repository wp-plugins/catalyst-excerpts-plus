	...
	$twitter_style_dates = true)
{
	...
	if (time() - $cachetime < $cache_file_created) {
		...
		//echo "<strong>Debug: RSS Used</strong><br />".$cachetime."<br />File Time: ".$cache_file_created."<br /><br /><br /><br /><br />";
...
/* Filter content with certain html tags allowed */
