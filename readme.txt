...
* Display latest tweets (Ignores tweets starting with @)
...
1. After activating the plugin, find the widget in your widget admin area.
2. Use the widget's options to setup how the excerpts will be selected and displayed.
...
= 1.2.3 =
* Fixed issue with Allow HTML in Excerpts option working oposite of how it was intended.
